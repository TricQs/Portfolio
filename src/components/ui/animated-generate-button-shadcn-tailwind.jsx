    ...
    <div className={clsx("relative inline-block", className)} id={id}>
      <button
        ...
        className={clsx(
          ...
          "bg-[#0e0e12] text-[#f5f5f7]",
          "border border-white/20",
          "shadow-[inset_0px_1px_1px_rgba(255,255,255,0.2),inset_0px_2px_2px_rgba(255,255,255,0.15),inset_0px_4px_4px_rgba(255,255,255,0.1),0_4px_20px_rgba(0,0,0,0.4)]",
      ...
      >
        <svg
          className={clsx(
            "ui-anim-btn-svg mr-2.5 h-5 w-5 flex-grow-0",
        ...
        <div className="ui-anim-txt-wrapper relative flex min-w-[7em] items-center justify-center">
          <div
            className={clsx(
              "ui-anim-txt-1 absolute text-xs font-semibold tracking-wide uppercase",
              generating ? "opacity-0 pointer-events-none" : "animate-[ui-appear_0.6s_ease-in-out_forwards]"
            )}
          >
          ...
          <div
            className={clsx(
              "ui-anim-txt-2 absolute text-xs font-semibold tracking-wide uppercase",
      ...
      <style jsx>{`
        ...
        /* Hover */
        .ui-anim-btn:hover {
          border-color: hsla(var(--highlight-hue), 100%, 80%, 0.5);
        }
        ...
        .ui-anim-btn:active .ui-anim-letter {
          text-shadow: 0 0 2px hsla(var(--highlight-hue), 100%, 90%, 0.9);
          animation: none;
        }
