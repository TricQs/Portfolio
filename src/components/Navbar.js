...
export default function Navbar() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      // When at the very top, keep Projects active so box never vanishes
            ...
            <div className="flex flex-col justify-center flex-grow gap-3 relative z-10 my-auto max-w-sm mx-auto w-full">
              {navLinks.map((link, i) => (
                ...
                >
                  ...
                  <span className="text-xs font-mono text-[#a1a1a6] group-hover:text-amber-400 transition-colors">
                    0{i + 1}
                  </span>
                </motion.button>
              ))}
