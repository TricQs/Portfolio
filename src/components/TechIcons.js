...
// Sublime Text Icon (Corrected S ribbon logo path without any outer circular border)
export function SublimeTextIcon({ size = 16, className = '', style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#FF9800" className={className} style={{ width: size, height: size, ...style }} aria-hidden="true">
...
// Notepad++ Icon (chameleon/document-edit)
export function NotepadPlusPlusIcon({ size = 16, className = '', style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#90C53F" strokeWidth="2" className={className} style={{ width: size, height: size, ...style }} aria-hidden="true">
      <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" fill="none" />
      <path d="M9 17h6M9 13h6M9 9h3" stroke="currentColor" strokeLinecap="round" />
      <path d="M18 6l-3-3v3h3z" fill="currentColor" stroke="none" />
    </svg>
  )
}
